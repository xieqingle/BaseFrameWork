...
*/
    ...
    public static final class Builder {
        ...
        public <T> Builder addHeader(Map<String, T> headers) {
            okhttpBuilder.addInterceptor(new com.tamic.novate.BaseInterceptor(Utils.checkNotNull(headers, "header == null")));
            return this;
        }
    ...
    public interface ResponseCallBack<T> {
        ...
        public abstract void onError(com.tamic.novate.Throwable e);
