...
public class XToolBar extends RelativeLayout {
    ...
    private void initAttribute(AttributeSet attrs) {
        TypedArray a = mContext.obtainStyledAttributes(attrs, R.styleable.XToolBar);

        int leftImageId = a.getResourceId(R.styleable.XToolBar_leftImageSrc, -1);
        mLeftImageWidth = (int) a.getDimension(R.styleable.XToolBar_leftImageWidth, mLeftImageWidth);
        mLeftImageHeight = (int) a.getDimension(R.styleable.XToolBar_leftImageHeight, mLeftImageHeight);

        String leftText = a.getString(R.styleable.XToolBar_leftText);
        mLeftTextWidth = (int) a.getDimension(R.styleable.XToolBar_leftTextWidth, mLeftTextWidth);
        mLeftTextHeight = (int) a.getDimension(R.styleable.XToolBar_leftTextHeight, mLeftTextHeight);
        mLeftTextSize = (int) a.getDimension(R.styleable.XToolBar_leftTextSize, mLeftTextSize);
        mLeftTextColor = a.getColor(R.styleable.XToolBar_leftTextColor, mLeftTextColor);
        mLeftTextGravity = a.getInt(R.styleable.XToolBar_leftTextGravity, mLeftTextGravity);
        int leftViewPaddingLeft = (int) a.getDimension(R.styleable.XToolBar_leftViewPaddingLeft, 0);
        int leftViewPaddingTop = (int) a.getDimension(R.styleable.XToolBar_leftViewPaddingTop, 0);
        int leftViewPaddingRight = (int) a.getDimension(R.styleable.XToolBar_leftViewPaddingRight, 0);
        int leftViewPaddingBottom = (int) a.getDimension(R.styleable.XToolBar_leftViewPaddingBottom, 0);
        int leftViewMarginLeft = (int) a.getDimension(R.styleable.XToolBar_leftViewMarginLeft, 0);
        int leftViewMarginTop = (int) a.getDimension(R.styleable.XToolBar_leftViewMarginTop, 0);
        int leftViewMarginRight = (int) a.getDimension(R.styleable.XToolBar_leftViewMarginRight, 0);
        int leftViewMarginBottom = (int) a.getDimension(R.styleable.XToolBar_leftViewMarginBottom, 0);

        String middleText = a.getString(R.styleable.XToolBar_middleText);
        mMiddleTextWidth = (int) a.getDimension(R.styleable.XToolBar_middleTextWidth, mMiddleTextWidth);
        mMiddleTextHeight = (int) a.getDimension(R.styleable.XToolBar_middleTextHeight, mMiddleTextHeight);
        mMiddleTextSize = (int) a.getDimension(R.styleable.XToolBar_middleTextSize, mMiddleTextSize);
        mMiddleTextColor = a.getColor(R.styleable.XToolBar_middleTextColor, mMiddleTextColor);
        mMiddleTextGravity = a.getInt(R.styleable.XToolBar_middleTextGravity, mMiddleTextGravity);
        middleTextMaxSize = (int) a.getDimension(R.styleable.XToolBar_middleTextMaxSize, 20);

//      中间文本左侧图片
        int middleTextLeftImage = a.getResourceId(R.styleable.XToolBar_middleTextLeftImage, 0);
//      中间文本上侧图片
        int middleTextTopImage = a.getResourceId(R.styleable.XToolBar_middleTextTopImage, 0);
//      中间文本下侧图片
        int middleTextRightImage = a.getResourceId(R.styleable.XToolBar_middleTextRightImage, 0);
        //中间文本右侧图片
        int middleTextBottomImage = a.getResourceId(R.styleable.XToolBar_middleTextBottomImage, 0);

        int middleTextPaddingLeft = (int) a.getDimension(R.styleable.XToolBar_middleTextPaddingLeft, 0);
        int middleTextPaddingTop = (int) a.getDimension(R.styleable.XToolBar_middleTextPaddingTop, 0);
        int middleTextPaddingRight = (int) a.getDimension(R.styleable.XToolBar_middleTextPaddingRight, 0);
        int middleTextPaddingBottom = (int) a.getDimension(R.styleable.XToolBar_middleTextPaddingBottom, 0);
        int middleTextMarginLeft = (int) a.getDimension(R.styleable.XToolBar_middleTextMarginLeft, 0);
        int middleTextMarginTop = (int) a.getDimension(R.styleable.XToolBar_middleTextMarginTop, 0);
        int middleTextMarginRight = (int) a.getDimension(R.styleable.XToolBar_middleTextMarginRight, 0);
        int middleTextMarginBottom = (int) a.getDimension(R.styleable.XToolBar_middleTextMarginBottom, 0);

        mMiddleEditBackground = a.getResourceId(R.styleable.XToolBar_middleEditBackground, -1);
        mMiddleEditHint = a.getString(R.styleable.XToolBar_middleEditHint);
        mMiddleEditTextText = a.getString(R.styleable.XToolBar_middleEditText);
        mMiddleEditWidth = (int) a.getDimension(R.styleable.XToolBar_middleEditWidth, mMiddleEditWidth);
        mMiddleEditHeight = (int) a.getDimension(R.styleable.XToolBar_middleEditHeight, mMiddleEditHeight);
        mMiddleEditTextSize = (int) a.getDimension(R.styleable.XToolBar_middleEditTextSize, mMiddleEditTextSize);
        mMiddleEditTextColor = a.getColor(R.styleable.XToolBar_middleEditColor, mMiddleEditTextColor);
        int middleEditPadding = (int) a.getDimension(R.styleable.XToolBar_middleEditPadding, -1);
        int middleEditMargin = (int) a.getDimension(R.styleable.XToolBar_middleEditMargin, -1);
        mMiddleEditGravity = a.getInt(R.styleable.XToolBar_middleEditGravity, mMiddleEditGravity);

        int middleEditPaddingLeft = (int) a.getDimension(R.styleable.XToolBar_middleEditPaddingLeft, 0);
        int middleEditPaddingTop = (int) a.getDimension(R.styleable.XToolBar_middleEditPaddingTop, 0);
        int middleEditPaddingRight = (int) a.getDimension(R.styleable.XToolBar_middleEditPaddingRight, 0);
        int middleEditPaddingBottom = (int) a.getDimension(R.styleable.XToolBar_middleEditPaddingBottom, 0);
        int middleEditMarginLeft = (int) a.getDimension(R.styleable.XToolBar_middleEditMarginLeft, 0);
        int middleEditMarginTop = (int) a.getDimension(R.styleable.XToolBar_middleEditMarginTop, 0);
        int middleEditMarginRight = (int) a.getDimension(R.styleable.XToolBar_middleEditMarginRight, 0);
        int middleEditMarginBottom = (int) a.getDimension(R.styleable.XToolBar_middleEditMarginBottom, 0);

        //      中间文本左侧图片
        int middleEditLeftImage = a.getResourceId(R.styleable.XToolBar_middleEditLeftImage, 0);
//      中间文本上侧图片
        int middleEditTopImage = a.getResourceId(R.styleable.XToolBar_middleEditTopImage, 0);
//      中间文本下侧图片
        int middleEditRightImage = a.getResourceId(R.styleable.XToolBar_middleEditRightImage, 0);
        //中间文本右侧图片
        int middleEditBottomImage = a.getResourceId(R.styleable.XToolBar_middleEditBottomImage, 0);

        int rightImageId = a.getResourceId(R.styleable.XToolBar_rightImageSrc, -1);
        mRightImageWidth = (int) a.getDimension(R.styleable.XToolBar_rightImageWidth, mRightImageWidth);
        mRightImageHeight = (int) a.getDimension(R.styleable.XToolBar_rightImageHeight, mRightImageHeight);

        String rightText = a.getString(R.styleable.XToolBar_rightText);
        mRightTextWidth = (int) a.getDimension(R.styleable.XToolBar_rightTextWidth, mRightTextWidth);
        mRightTextHeight = (int) a.getDimension(R.styleable.XToolBar_rightTextHeight, mRightTextHeight);
        mRightTextSize = (int) a.getDimension(R.styleable.XToolBar_rightTextSize, mRightTextSize);
        mRightTextColor = a.getColor(R.styleable.XToolBar_rightTextColor, mRightTextColor);
        mRightTextGravity = a.getInt(R.styleable.XToolBar_rightTextGravity, mRightTextGravity);
        rightViewCheckBoxBackground = a.getResourceId(R.styleable.XToolBar_rightViewCheckBoxBackground, -1);
        boolean rightViewIsCheck = a.getBoolean(R.styleable.XToolBar_rightViewIsCheck, false);
        mRightCheckBoxWidth = (int) a.getDimension(R.styleable.XToolBar_rightViewCheckBoxWidth, mRightCheckBoxWidth);
        mRightCheckBoxHeight = (int) a.getDimension(R.styleable.XToolBar_rightViewCheckBoxHeight, mRightCheckBoxHeight);
        int rightCheckBoxButton = a.getResourceId(R.styleable.XToolBar_rightCheckBoxButton, -1);

        int rightViewPaddingLeft = (int) a.getDimension(R.styleable.XToolBar_rightViewPaddingLeft, 0);
        int rightViewPaddingTop = (int) a.getDimension(R.styleable.XToolBar_rightViewPaddingTop, 0);
        int rightViewPaddingRight = (int) a.getDimension(R.styleable.XToolBar_rightViewPaddingRight, 0);
        int rightViewPaddingBottom = (int) a.getDimension(R.styleable.XToolBar_rightViewPaddingBottom, 0);
        int rightViewMarginLeft = (int) a.getDimension(R.styleable.XToolBar_rightViewMarginLeft, 0);
        int rightViewMarginTop = (int) a.getDimension(R.styleable.XToolBar_rightViewMarginTop, 0);
        int rightViewMarginRight = (int) a.getDimension(R.styleable.XToolBar_rightViewMarginRight, 0);
        int rightViewMarginBottom = (int) a.getDimension(R.styleable.XToolBar_rightViewMarginBottom, 0);
        Drawable rightImageBackground = a.getDrawable(R.styleable.XToolBar_rightTextBackground);

        final String onLeftViewClick = a.getString(R.styleable.XToolBar_onLeftViewClick);
        final String onRightViewClick = a.getString(R.styleable.XToolBar_onRightViewClick);
