...
public class FileUploadUtils {
     ...
     */
    public static MultipartBody path2Builder(@Nullable List<String> filePaths) {
     ...
     * @return 上传的multipartBody
     */
    public static MultipartBody path2Builder(@Nullable List<String> filePaths, ProgressRequestBody.Listener listener) {
        RequestBody requestBody;
        MultipartBody.Builder builder = new MultipartBody.Builder();
        for (String filePath : filePaths) {
            File file = new File(filePath);
     ...
     * @return 上传的multipartBody
     */
    public static MultipartBody file2Builder(@Nullable List<File> files) {
        RequestBody requestBody;
        MultipartBody.Builder builder = new MultipartBody.Builder();
        for (File file : files) {
            if (!file.exists())
     ...
     * @return 上传的multipartBody
     */
    public static MultipartBody file2Builder(@Nullable List<File> files, ProgressRequestBody.Listener listener) {
        RequestBody requestBody;
        MultipartBody.Builder builder = new MultipartBody.Builder();
        for (File file : files) {
            if (!file.exists())
     ...
     */
    public static List<MultipartBody.Part> path2Parts(@Nullable List<String> filePaths) {
        RequestBody requestBody;
     ...
     * @return 上传的  List<MultipartBody.Part>
     */
    public static List<MultipartBody.Part> path2Parts(@Nullable List<String> filePaths, ProgressRequestBody.Listener listener) {
        RequestBody requestBody;
        List<MultipartBody.Part> parts = new ArrayList<>(filePaths.size());
        for (String filePath : filePaths) {
            File file = new File(filePath);
     ...
     * @return 上传的  List<MultipartBody.Part>
     */
    public static List<MultipartBody.Part> file2Parts(@Nullable List<File> files) {
        RequestBody requestBody;
     ...
     * @return 上传的  List<MultipartBody.Part>
     */
    public static List<MultipartBody.Part> file2Parts(@Nullable List<File> files, ProgressRequestBody.Listener listener) {
        RequestBody requestBody;
        List<MultipartBody.Part> parts = new ArrayList<>(files.size());
        for (File file : files) {
            if (!file.exists())
